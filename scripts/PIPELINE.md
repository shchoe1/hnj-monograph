...
(외부 의존 `requests`/`Levenshtein` 등은 구(舊) `verify_doi.py` 전용이며, 신규 파이프라인은 불필요).
...
- 완료(①~④): Ch1~3(서장), Ch4~10, Ch9
- **드래프트(①②만 · ③④ 대기): Ch11 · L-티로신** ← 다음 작업은 여기서 ③부터
- 예정: Ch12(L-글루타민) · Ch13(커큐민) · Ch14(FOS·팔라티노스) · Ch15(종장)
