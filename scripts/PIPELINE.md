...
- 완료(①~④): Ch1~3(서장), Ch4~11 (Ch11 L-티로신: 32/32 DOI-VERIFIED·편집 완료·저자 승인 대기)
- **드래프트(①②만 · ③④ 대기): Ch12 · L-글루타민** (38편 큐레이션·15섹션 초고·본문↔목록 1:1) ← 다음은 여기서 ③(reference-validator)부터
- 예정: Ch13(커큐민) · Ch14(FOS·팔라티노스) · Ch15(종장)
